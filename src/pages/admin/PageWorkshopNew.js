...
export class PageAdminWorkshopNew extends AdminPageTemplate {
  constructor(req) {
    super(req);
  ...
  async main() {
    return `
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <h1 class="h2">New Workshop</h1>
                <form action="/api/admin/workshops" data-method="POST" class="needs-validation col-12 col-md-10 col-lg-8 col-xl-6">
                    <div class="row g-3">
                        <div class="col-sm-12">
